class Review < ApplicationRecord
  ...
  def update_final_rating
    ratingTotal=cleanliness_rating+accuracy_rating+checkin_rating+communication_rating+location_rating+value_rating
    update_column(:final_rating,ratingTotal.to_f/6)
